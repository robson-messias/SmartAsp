...
namespace SmartAsp.Controllers
{
    public class ProductsController : Controller
    {
        private readonly SmartAspContext _context;
        ...
        {
            var smartAspContext = _context.Product.Include(p => p.Brand).Include(p => p.Department);
            return View(await smartAspContext.ToListAsync());
        }
